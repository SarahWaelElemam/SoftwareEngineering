...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">    <title>Event Page</title>
  ...
  <?php include '../includes/NavBar.php'; ?>
    ...
    <h2>About Event</h2>
    <p>
      The iconic and forever funny, Ahmed Helmy, returns to theatre with a hit play! 
      A satire take on society in social media times, with a huge success in KSA, now in Egypt. 
      Alongside a line-up of top-tier comedians. Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis aliquam magni natus assumenda ab, perspiciatis ipsum commodi saepe dignissimos. In qui est dolor quas reprehenderit unde eveniet provident sed dolorem.. Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis aliquam magni natus assumenda ab, perspiciatis ipsum commodi saepe dignissimos. In qui est dolor quas reprehenderit unde eveniet provident sed dolorem.
    </p>
  </div>
    ...
    <div class="ticket-section">
      ...
      <div class="ticket-container">
        ...
        <div class="ticket">
          <h3>Platinum</h3>
          <p>EGP 1250</p>
          <button class="ticket-btn" onclick="openModal('Royal', 2500)">Buy Now</button>        </div>
        <div class="ticket">
          <h3>Diamond</h3>
          <p>EGP 1500</p>
      ...
      <div class="venue-container">
        <div class="venue-details">
          ...
          <div class="venue-facilities">
            <h4>FACILITIES</h4>
            <p>🛁 Bathrooms | 🍽️ Food Services</p>
            <p>🅿️ Parking | 🛡️ Security</p>
          </div>
        </div>
  ...
  <script>function openModal(ticketType, ticketPrice) {
...
// Function to confirm the purchase (this can be expanded to handle purchase logic)
